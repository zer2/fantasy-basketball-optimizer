...
The turnovers category is the only one which is won by the team with the lower score, rather than the team with the higher score. Because of this unique property and the issues caused by it, many fantasy basketball analysts recommend down-weighting the turnovers category to a low weight like $25\%$ or even $0\%$ relative to what Z-scores would otherwise tell them. 
