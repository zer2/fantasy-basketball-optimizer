...
The statement of fact is incontrovertibly true. However, concluding from it that doing well in turnovers does not increase overall win probability is a fallacy akin to [reverse causality](https://en.wikipedia.org/wiki/Correlation_does_not_imply_causation). __It may be true that doing well in turnovers is associated with losing overall. However, that does not preclude the possibility that doing better in turnovers causally improves the chance of overall victory__ 
