...
__TL;DR: It is irrelevant that winning turnovers is associated with losing matchups. What matters is whether, in match-ups that are close, doing a bit better in turnovers is worth as much as doing a bit better in other categories. The math suggests that it is, meaning that there is no reason to de-weight turnovers__
