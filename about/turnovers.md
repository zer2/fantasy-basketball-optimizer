...
__TL;DR: It is irrelevant that winning matchups is associated with losing turnovers. What matters is whether on the margins, investing in turnovers flips losses into wins as often as investing in other categories does. Intuition and math both suggest that it does, providing no justification for de-weighting turnovers__
