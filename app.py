  ...
  with right:
    ...
    with team_tab:
      ...
      with z_tab:
        ...
        team_stats = team_stats.style.format("{:.2}").map(other_styler).map(stat_styler, subset = pd.IndexSlice[team_players, counting_statistics + percentage_statistics])
