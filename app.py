...
with st.sidebar:
  with st.popover('League Settings'):
  ...
  if data_source == 'Enter your own data':
      ...
      with st.popover('Teams & Autodraft'):
  ...
  with st.popover('Format & Categories'):
  ...
  with st.popover('Position Requirements'):
  ...
  with st.popover('Player Stat Parameters'):
  ...
  with st.popover('Algorithm Parameters').container(height = 300):
  ...
  with st.popover('Trade Parameters').container(height = 300):
