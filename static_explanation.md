...
Ranking players quantitatively requires a metric by which to judge players. The standard metric for category leagues is called 'Z-scoring', and it is often used to make objective rankings of players. However, when I looked for a mathematical argument explaining why Z-scores work, I could not find one.
